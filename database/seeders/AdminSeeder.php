...
class AdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin = [
            ['name'  => 'Admin','email' => 'admin@admin.com','password' =>bcrypt('password'),'phone' => '9988776655','dob' => '1996/01/01'],
            ['name'  => 'Editor','email' => 'editor@editor.com','password' =>bcrypt('password'),'phone' => '9988776655','dob' => '1996/01/01'],
            ['name'  => 'Author','email' => 'author@author.com','password' =>bcrypt('password'),'phone' => '9988776655','dob' => '1996/01/01'],
        ];
        Admin::insert($admin);
