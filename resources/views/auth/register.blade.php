    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="phone" class="block w-full mt-1" type="number" name="phone" :value="old('phone')" required autofocus />
            </div>
            ...
            <div>
                ...
                <x-input id="dob" class="block w-full mt-1" type="date" name="dob" :value="old('dob')" required autofocus />
            </div>
